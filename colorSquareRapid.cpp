...
ColorSquareRapid::ColorSquareRapid() {
	...
	for(int i = 0; i < sideLength; i++) {
		...
		picture_2.m_side[i][0].r = 255;	//Side Rainbows
		picture_2.m_side[i][1].r = 255;
		picture_2.m_side[i][1].g = 127;
		picture_2.m_side[i][2].r = 255;
		picture_2.m_side[i][2].g = 255;
		picture_2.m_side[i][3].g = 255;
		picture_2.m_side[i][4].b = 255;
		picture_2.m_side[i][5].r = 75;
		picture_2.m_side[i][5].b = 130;
		picture_2.m_side[i][6].r = 143;
		picture_2.m_side[i][6].b = 255;	
	}

	picture_1.delay = 10000;
	picture_2.delay = 10000;

	counter = 0;

}

const Frame* ColorSquareRapid::getNextFrame() {
